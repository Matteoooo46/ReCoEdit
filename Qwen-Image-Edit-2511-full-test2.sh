...
export WANDB_API_KEY="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"
...
accelerate launch --config_file /data/phd/kousiqi/zhitao/DiffSynth-Studio/examples/qwen_image/model_training/full/accelerate_config.yaml \
  ...
  --resume_from_checkpoint "/data/phd/kousiqi/zhitao/full_all_products_rewrite_expanded_ultimate_test2_resume_25000/step-21000.safetensors" \
  --output_path "/data/phd/kousiqi/zhitao/full_all_products_rewrite_expanded_ultimate_test2_resume_46000" \
