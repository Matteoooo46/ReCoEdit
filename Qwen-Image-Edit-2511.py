...
edit_image = [
Image.open("/data/phd/kousiqi/zhitao/shipin_23397479040558_consistency/test01.jpg").convert("RGB"),
...
image.save("/data/phd/kousiqi/zhitao/shipin_23397479040558_consistency/test02.jpg")
