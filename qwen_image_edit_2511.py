...
# ==========================================
# ⚠️ 填入你要推理的那个产品的文件夹路径
TARGET_WORKSPACE_DIR = "/data/phd/lijiahui/data/batch_no_voice_gen_fuzhuang/workspace_item_22550162050189"
...
RAW_OUTPUT_DIR = os.path.join(OUTPUT_BASE_DIR, f"{product_name}_raw_expanded")
...
ref_table.add_data("character", wandb.Image(char_img_path))
