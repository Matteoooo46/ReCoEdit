#!/usr/bin/env bash
# qwen_image_edit_2511_new_with_prompt_rewrite_and_html.py 的 8-GPU 并行启动脚本
# 8 个产品占 GPU 0-7

set -euo pipefail

SCRIPT="/data/phd/kousiqi/zhitao/inference/qwen_image_edit_2511_new_original_prompt.py"
